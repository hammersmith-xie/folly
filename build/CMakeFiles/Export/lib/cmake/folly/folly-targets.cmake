...
set_target_properties(Folly::folly_deps PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/usr/local/include;/usr/local/openssl/include;/usr/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "fmt::fmt;Threads::Threads;Boost::context;Boost::filesystem;Boost::program_options;Boost::regex;Boost::system;Boost::thread;/usr/local/lib/libdouble-conversion.so;gflags_shared;/usr/local/lib/libglog.so;/usr/local/lib/libevent.so;/usr/local/lib/libz.so;/usr/local/openssl/lib/libssl.so;/usr/local/openssl/lib/libcrypto.so;/usr/lib/x86_64-linux-gnu/libbz2.so;/usr/lib/x86_64-linux-gnu/liblzma.so;/usr/local/lib/liblz4.so;/usr/local/lib/libzstd.so;/usr/lib/x86_64-linux-gnu/libsnappy.so;dl"
)
